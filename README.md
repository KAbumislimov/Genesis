...
Отдельное спасибо коллегам, которые помогали советом и поддержкой на этом пути — **Самир муэллим** (идея, с которой всё завертелось в нужную сторону) и **Nicat** (показал, как вообще плавать в этом деле). Без вас это осталось бы одним тонким клиентом на столе.
...
- **Самир муэллим** — за идею, с которой всё это по-настоящему сдвинулось с места
- **Nicat** — за то, что показал, как вообще ориентироваться во всём этом
