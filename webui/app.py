...
_UI_FEATURES = {
    ...
    'glass':   ['Фон дышит в такт музыке', 'Матовое стекло'],
    'rows':    ['Горизонтальные фейдеры', 'Кнопки −/+', 'Мастер закреплён'],
    'dial':    ['Круглые регуляторы', 'Колёсико мыши', 'Стрелки клавиатуры'],
    'oled':    ['Чистый чёрный', 'Огромные цифры'],
    'soft':    ['Светлый мягкий', 'Объёмные кнопки'],
    'onair':   ['Вывеска ON AIR', 'Пульсация в такт музыке'],
    'compact': ['Пресеты 50/100/130/150', 'Кнопки −/+', 'Для планшета'],
}
