...
const I18N = {
  ru: {
    ...
    'wamp.campus_label': 'Кампус', 'wamp.campus_all': 'ВСЕ',
    ...
    'toast.pick_single_campus': '⚠️ Выберите конкретный кампус (не ВСЕ) для этого действия',
    /* Silence */
  ...
  en: {
    ...
    'wamp.campus_label': 'Campus', 'wamp.campus_all': 'ALL',
    ...
    'toast.pick_single_campus': '⚠️ Pick a specific campus (not ALL) for this action',
    /* Silence */
  ...
  az: {
    ...
    'wamp.campus_label': 'Kampus', 'wamp.campus_all': 'HAMISI',
    ...
    'toast.pick_single_campus': '⚠️ Bu əməliyyat üçün konkret kampus seçin (HAMISI yox)',
    /* Silence */
